...
class Dataset:
    def __init__(self, conf):
        ...
        self.sphere_radius = self.scale_mats_np[0].astype(float)[0,0]
        self.sphere_center = self.scale_mats_np[0].astype(float)[:3, 3].tolist()
        self.intrinsics_all = []
        self.pose_all = []
...
def generate(dataset_name, base_par_dir, copy_image=True, is_downsample=False, downsample_scale=1, fixed_camera=True, wrong_camera=[]):
    ...
    output = {
        "w": W,
        "h": H,
        "sphere_radius": dataset.sphere_radius,
        "sphere_center": dataset.sphere_center,
        # "aabb_scale": 1.0,
        # "scale": 0.5,
...
if __name__ == "__main__":
    ...
    # python scripts/data_format_from_neus.py --dataset_all --copy_image
